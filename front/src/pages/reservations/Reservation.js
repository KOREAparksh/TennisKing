...
function Reservation() {
  const getToday = () => {
    ...
    const m = temp.toString().length < 2 ? "0" + temp.toString() : temp.toString();
      ...
      <form className='Form'>
        <fieldset>
          ...
          <div className='Row'>
            ...
            <div className='Input'>
              <input id="setStartDate" min={today} type="date" className='InputTag InputTagText' onChange={getSetDay}
                     required>
              </input>
          ...
          <div id='BookTime'>
            ...
            <div>
              <contents>위 선택한 모든 날짜에 옵션이 적용됩니다.</contents>
            </div>
            <div className='TableDiv'>
              <table border="1">
                <tr>
                  <td>
                    <input type="checkbox" id='first' name='select_time' checked={Check1} onChange={BtnEvent1}></input>1회:
                    06:00 ~ 08:00
                  </td>
                  <td>
                    <input type="checkbox" id='fifth' name='select_time' checked={Check5} onChange={BtnEvent5}></input>5회:
                    14:00 ~ 16:00
                  </td>
                </tr>
                <tr>
                  <td>
                    <input type="checkbox" id='second' name='select_time' checked={Check2} onChange={BtnEvent2}></input>2회:
                    08:00 ~ 10:00
                  </td>
                  <td>
                    <input type="checkbox" id='sixth' name='select_time' checked={Check6} onChange={BtnEvent6}></input>6회:
                    16:00 ~ 18:00
                  </td>
                </tr>
                <tr>
                  <td>
                    <input type="checkbox" id='thrid' name='select_time' checked={Check3} onChange={BtnEvent3}></input>3회:
                    10:00 ~ 12:00
                  </td>
                  <td>
                    <input type="checkbox" id='seven' name='select_time' checked={Check7} onChange={BtnEvent7}></input>7회:
                    18:00 ~ 20:00
                  </td>
                </tr>
                <tr>
                  <td>
                    <input type="checkbox" id='four' name='select_time' checked={Check4} onChange={BtnEvent4}></input>4회:
                    12:00 ~ 14:00
                  </td>
                  <td>
                    <input type="checkbox" id='eight' name='select_time' checked={Check8} onChange={BtnEvent8}></input>8회:
                    20:00 ~ 22:00
                  </td>
                </tr>
              </table>
