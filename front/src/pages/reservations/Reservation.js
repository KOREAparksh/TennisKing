...
function Reservation() {
    ...
    const deleteDate = (e) => {
        e.preventDefault();
        const new_dates = [...reserveDates];
        if (new_dates.length > 1) new_dates.pop();
        setReserveDates(new_dates);
    };
    ...
    const onClickOption1 = (e) => {
        if (option1 === false) setOption1(true);
        else setOption1(false);
    };
    ...
    const onSubmit = (event) => {
        ...
        const place_id = placeList.filter((data) => {
            if (data.com_name === com_name && data.part_name === part_name && data.place_name === place_name) return true;
            return false;
        })[0].id;
        const reserve_times = [];
        const hour_mili = 60 * 60 * 1000;
        reserveDates.map(function (data) {
            if (Check1 === true) reserve_times.push(new Date(Date.parse(data) + -3 * hour_mili));
            if (Check2 === true) reserve_times.push(new Date(Date.parse(data) + -1 * hour_mili));
            if (Check3 === true) reserve_times.push(new Date(Date.parse(data) + 1 * hour_mili));
            if (Check4 === true) reserve_times.push(new Date(Date.parse(data) + 3 * hour_mili));
            if (Check5 === true) reserve_times.push(new Date(Date.parse(data) + 5 * hour_mili));
            if (Check6 === true) reserve_times.push(new Date(Date.parse(data) + 7 * hour_mili));
            if (Check7 === true) reserve_times.push(new Date(Date.parse(data) + 9 * hour_mili));
                ...
                <div className="Container">
                    <form className="Form">
                        <fieldset>
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">프로그램 시작 시각</div>
                                </div>
                                <div className="Input">
                                    <input
                                        id="setStartDate"
                                        ...
                                        min={minDate}
                                        type="date"
                                        className="InputTag InputTagText"
                                        onChange={getSetDay}
                                        required
                                    ></input>
                                    <input
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">시설</div>
                                </div>
                                <div className="Input">
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">시설상세1</div>
                                </div>
                                <div className="Input">
                                    <select
                                        id="facility-detail1"
                                        name="facility-detail1"
                                        className="Select"
                                        required
                                        onChange={onChangeFacilityDetail1}
                                    >
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">시설상세2</div>
                                </div>
                                <div className="Input">
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">아이디</div>
                                </div>
                                <div className="Input">
                                    <input
                                        type="text"
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">비밀번호</div>
                                </div>
                                <div className="Input">
                                    <input
                                        type="password"
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">인원 수</div>
                                </div>
                                <div className="Input">
                                    <input
                                        type="number"
                            ...
                            <div id="BookDate">
                                <div>
                                    <div className="TitleTag FormRowTitle">예약할 날짜 설정</div>
                                </div>
                                <div>
                                    {reserveDates.map((date, index) => (
                                        <div id="InputDate">
                                            <input
                                                ...
                                                type="date"
                                                className="InputTag"
                                                onChange={(e) => onClickReserveDate(e, index)}
                                                min={min}
                                                required
                                            ></input>
                                        </div>
                            ...
                            <div id="BookTime">
                                <div className="TitleTag FormRowTitle">회차옵션</div>
                                ...
                                <div className="TableDiv">
                                    ...
                                    <input type="checkbox" id="all" name="all" checked={allCheck} onChange={allBtnEvent}></input>
                                    전체선택
                                </div>
                            </div>
                            ...
                            <div className="Row">
                                <div className="Title">
                                    <div className="TitleTag FormRowTitle">부가옵션</div>
                                </div>
                                <div className="Input">
                                    <div id="OptionDiv">
                                        <input
